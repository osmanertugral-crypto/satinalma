...
export default function POPage() {
  ...
  const [sortBy, setSortBy] = useState('date_desc'); // date_desc | date_asc | supplier
  ...
  const pos = [...rawPos].sort((a, b) => {
    ...
    return (b.order_date || '').localeCompare(a.order_date || ''); // date_desc default
  });
          ...
          <Table headers={['PO No', 'Tedarikçi', 'Sipariş Tarihi', 'Beklenen Teslimat', 'Tutar', 'Durum', 'İşlem']}
            ...
            {pos.map(po => (
              <tr key={po.id} className="border-b border-gray-100 hover:bg-gray-50">
                ...
                <td className="px-4 py-3 text-sm text-gray-500">{po.expected_date || '-'}</td>
